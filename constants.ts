...
export const ROLE_EXTENDED_DATA: Record<number, RoleExtendedDetails> = {
  ...
  4: {
    ...
    trainingProcess: [
      {
        title: 'טירונות חי"ר ולוט"ר',
        duration: 'מספר חודשים',
        description: 'ההכשרה מתחילה בטירונות חי"ר, ממשיכה עם קורס לוחמה בטרור (לוט"ר) וחיזוק יכולות בסיסיות.'
      },
      {
        title: 'הכשרה ייעודית',
        duration: 'סה"כ 22 חודשים',
        description: 'קורסים מיוחדים ומסווגים בתחומי קומנדו, לחימת שטח, צניחה, ניווט, ג\'יפים, לחימה באזור עירוני ושימוש באמצעים טכנולוגיים מתקדמים.'
      },
      {
        title: 'אימונים מסכמים',
        description: 'הדמיות של מצבים מורכבים הכוללים היתקלות ישירה עם אויב, הישרדות בשטחים עוינים, ותרגול במתקן אימונים ייחודי המדמה לחימה עירונית.'
      }
    ]
  },
  5: {
    ...
    trainingProcess: [
      {
        ...
        duration: 'כחצי שנה',
        description: 'טירונות משותפת בביסל"ח 314 עם יחידת שלדג ויחידת ההנחתה הקדמית, ולאחריה טירונות יחידה 08.'
      },
      {
        title: 'הכשרות מקצועיות',
        duration: 'מספר חודשים',
        description: 'קורס חובשים קרביים, קורס מ"כים וקורס לוט"ר (לוחמה בטרור).'
      },
      {
        title: 'השלב ייעודי',
        duration: 'כ-8 חודשים',
