...
export const ROLES_DB: Role[] = [
  ...
  { id: 14, slug: 'yamas', name: 'ימ"ס', type: 'משטרת ישראל', rank: 14, minProfile: 82, minDapr: 30, tags: 'AgHxd', fitnessRequired: 1 },
  { id: 15, slug: 'yahalom', name: 'יהל"ם', type: 'חיל ההנדסה הקרבית', rank: 15, minProfile: 82, minDapr: 50, tags: 'Atsfd', fitnessRequired: 2 },
  { id: 22, slug: 'oketz', name: 'עוקץ', type: 'זרוע היבשה', rank: 16, minProfile: 82, minDapr: 30, tags: 'AlfGd', fitnessRequired: 2 },
  { id: 16, slug: 'sayeret-tzanhanim', name: 'סיירת צנחנים', type: 'חיל הרגלים', note: 'חי"ר', rank: 17, minProfile: 82, minDapr: 40, tags: 'Ad', fitnessRequired: 1 },
  { id: 17, slug: 'sayeret-golani', name: 'סיירת גולני', type: 'חיל הרגלים', note: 'חי"ר', rank: 18, minProfile: 82, minDapr: 30, tags: 'AHd', fitnessRequired: 2 },
  { id: 19, slug: 'sayeret-givati', name: 'סיירת גבעתי', type: 'חיל הרגלים', note: 'חי"ר', rank: 19, minProfile: 82, minDapr: 30, tags: 'Ahd', fitnessRequired: 2 },
  { id: 57, slug: 'lohem-ishim', name: 'לוחם אישים', type: 'אגף המבצעים', rank: 20, minProfile: 82, minDapr: 50, tags: 'agx', fitnessRequired: 2 },
  { id: 21, slug: 'zik', name: 'זיק', type: 'חיל התותחנים', note:'תותחנים', rank: 21, minProfile: 82, minDapr: 60, tags: 'TSfGx', fitnessRequired: 3 },
  { id: 23, slug: 'rav-memadit', name: 'היחידה הרב-ממדית', type: 'זרוע היבשה', rank: 22, minProfile: 82, minDapr: 40, tags: 'atg', fitnessRequired: 2 },
  { id: 25, slug: 'lotar', name: 'לוט"ר', type: 'זרוע היבשה', rank: 23, minProfile: 82, minDapr: 50, tags: 'acfg', fitnessRequired: 2 },
  { id: 18, slug: 'sayeret-nahal', name: 'סיירת נח"ל', type: 'חיל הרגלים', note: 'חי"ר', rank: 24, minProfile: 82, minDapr: 30, tags: 'Ad', fitnessRequired: 2 },
  { id: 20, slug: 'sayeret-haruv', name: 'סיירת חרוב', type: 'חיל הרגלים', note: 'חי"ר', rank: 25, minProfile: 82, minDapr: 30, tags: 'AHd', fitnessRequired: 2 },
  { id: 26, slug: 'meitar', name: 'מיתר', type: 'חיל התותחנים', note:'תותחנים', rank: 26, minProfile: 82, minDapr: 50, tags: 'Tsfgx', fitnessRequired: 3 },
  { id: 27, slug: 'moran', name: 'מורן', type: 'חיל התותחנים', note:'תותחנים', rank: 27, minProfile: 82, minDapr: 50, tags: 'Tsfgx', fitnessRequired: 3 },
  { id: 56, slug: 'malar', name: 'מלא"ר', type: 'חיל השריון', note:'שריון', rank: 28, minProfile: 82, minDapr: 50, tags: 'aTsfg', fitnessRequired: 2 },
  { id: 28, slug: 'rochesh', name: 'רוכ"ש', type: 'חיל התותחנים', note:'תותחנים', rank: 29, minProfile: 82, minDapr: 50, tags: 'aTsfgd', fitnessRequired: 2 },
  { id: 29, slug: 'yaltam', name: 'ילת"ם', type: 'חיל הים', rank: 30, minProfile: 72, minDapr: 50, tags: 'tfoG', fitnessRequired: 2 },
  { id: 30, slug: 'snapir', name: 'לוחם סנפיר', type: 'חיל הים', rank: 31, minProfile: 72, minDapr: 30, tags: 'foG', fitnessRequired: 2 },
  { id: 58, slug: 'tazpitan-haman', name: 'תצפיתן חמ"ן', type: 'חיל המודיעין', rank: 32, minProfile: 72, minDapr: 50, tags: 'tfgx', fitnessRequired: 4 },
  { id: 31, slug: 'modal', name: 'מודא"ל (מודיעין אלקטרוני)', type: 'חיל האוויר', rank: 33, minProfile: 72, minDapr: 50, tags: 'TSfGx', fitnessRequired: 4 },
  { id: 32, slug: 'mafil-la', name: 'מפעיל ל"א', type: 'חיל האוויר', rank: 34, minProfile: 72, minDapr: 50, tags: 'TSfGx', fitnessRequired: 4 },
  { id: 44, slug: 'manhit-saar', name: 'מנחית סער קדמי', type: 'חיל האוויר', rank: 35, minProfile: 82, minDapr: 50, tags: 'fg', fitnessRequired: 4 },
  { id: 33, slug: 'kamat', name: 'קצין מודיעין טקטי', type: 'חיל המודיעין', note: 'ייעודי לקצונה', rank: 36, minProfile: 72, minDapr: 60, tags: 'cltSfGx', fitnessRequired: 3 },
  { id: 34, slug: 'kashrag', name: 'קשר"ג', type: 'חיל התקשוב', note: 'ייעודי לקצונה', rank: 37, minProfile: 72, minDapr: 60, tags: 'cltSfg', fitnessRequired: 3 },
  { id: 35, slug: 'baz', name: 'בז', type: 'חיל השריון', note: 'ייעודי לקצונה שריון', rank: 38, minProfile: 72, minDapr: 60, tags: 'Aclgd', fitnessRequired: 2 },
  { id: 36, slug: 'meteor', name: 'מטאור', type: 'חיל התותחנים', note: 'ייעודי לקצונה תותחנים', rank: 39, minProfile: 72, minDapr: 60, tags: 'cltfg', fitnessRequired: 2 },
  { id: 37, slug: 'tzanhanim', name: 'צנחנים', type: 'חיל הרגלים', note: 'חי"ר', rank: 40, minProfile: 82, minDapr: 40, tags: 'Ad', fitnessRequired: 2 },
  { id: 38, slug: 'golani', name: 'גולני', type: 'חיל הרגלים', note: 'חי"ר', rank: 41, minProfile: 82, minDapr: 30, tags: 'AHdn', fitnessRequired: 3 },
  { id: 39, slug: 'givati', name: 'גבעתי', type: 'חיל הרגלים', note: 'חי"ר', rank: 42, minProfile: 82, minDapr: 30, tags: 'Ahdn', fitnessRequired: 3 },
  { id: 40, slug: 'nahal', name: 'נח"ל', type: 'חיל הרגלים', note: 'חי"ר', rank: 43, minProfile: 82, minDapr: 30, tags: 'Adn', fitnessRequired: 3 },
  { id: 41, slug: 'kfir', name: 'כפיר', type: 'חיל הרגלים', note: 'חי"ר', rank: 44, minProfile: 82, minDapr: 30, tags: 'AHdn', fitnessRequired: 3 },
  { id: 42, slug: 'hod-yami', name: 'לוחם חוד ימי', type: 'חיל הים', rank: 45, minProfile: 72, minDapr: 30, tags: 'tfog', fitnessRequired: 4 },
  { id: 43, slug: 'magav', name: 'מג"ב', type: 'משטרת ישראל', rank: 46, minProfile: 82, minDapr: 30, tags: 'afHdn', fitnessRequired: 4 },
  { id: 45, slug: 'niyud-444', name: 'יחידת הניוד 444', type: 'זרוע היבשה', rank: 47, minProfile: 82, minDapr: 30, tags: 'cgh', fitnessRequired: 3 },
  { id: 46, slug: 'lohem-la', name: 'לוחם ל"א (לוחמה אלקטרונית)', type: 'חיל התקשוב', rank: 48, minProfile: 72, minDapr: 50, tags: 'tfx', fitnessRequired: 4 },
  { id: 47, slug: 'handasa-kravit', name: 'הנדסה קרבית', type: 'חיל ההנדסה הקרבית', rank: 49, minProfile: 82, minDapr: 40, tags: 'Atdn', fitnessRequired: 4 },
  { id: 48, slug: 'shiryon', name: 'שריון', type: 'חיל השריון', rank: 50, minProfile: 72, minDapr: 40, tags: 'Atdn', fitnessRequired: 4 },
  { id: 52, slug: 'isuf-kravi', name: 'איסוף קרבי', type: 'חיל האיסוף', rank: 51, minProfile: 82, minDapr: 30, tags: 'tfnf', fitnessRequired: 4 },
  { id: 49, slug: 'tothanim', name: 'תותחנים', type: 'חיל התותחנים', rank: 52, minProfile: 72, minDapr: 40, tags: 'tfnf', fitnessRequired: 4 },
  { id: 51, slug: 'hagana-avirit', name: 'הגנה אווירית', type: 'חיל האוויר', rank: 53, minProfile: 72, minDapr: 40, tags: 'Tfnf', fitnessRequired: 4 },
  { id: 53, slug: 'palhatz', name: 'פלח"ץ (חילוץ והצלה)', type: 'פיקוד העורף', rank: 54, minProfile: 72, minDapr: 30, tags: 'fhn', fitnessRequired: 4 },
  { id: 54, slug: 'hir-gvulot', name: 'חי"ר גבולות', type: 'חיל הגנת הגבולות', rank: 55, minProfile: 72, minDapr: 30, tags: 'afhn', fitnessRequired: 4 },
  { id: 55, slug: 'maavarim', name: 'לוחם מעברים', type: 'חיל המשטרה הצבאית', rank: 56, minProfile: 64, minDapr: 30, tags: 'fhn', fitnessRequired: 4 },
];
    ...
    selectionPaths: [
      {
        ...
        steps: [
          'גיוס לנח"ל / גבעתי',
          ' מעבר גיבוש יח"טיות (תוצאת רבמ"ד)',
          'שיבוץ ליחידה'
        ]
      },
      {
